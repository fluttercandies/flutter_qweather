...
mixin _Historical on _ServiceApi {
  ...
  Future<HistoricalWeatherRsp?> getHistoricalWeather(String location, String date) async {
  ...
  /// date: 查询日期，日期格式为yyyyMMdd，例如 20200531
  Future<HistoricalHourlyAirRsp?> getHistoricalAir(String location, String date) async {
    Map param = {"location": location, "date": date};
    Map? value = await _methodChannel.invokeMapMethod(
